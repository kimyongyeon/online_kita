...
<body>
	...
	<div id="wrapper">
		<!-- Head -->
		<% String action = "KoreanWaveList.jsp"; %>
					...
					<tbody>
						...
						else
						{
							...
							<tr>
								...
								<td class="left"><a href="KoreanWaveView.jsp?newsNo=<%=vnbListDao.getInt(i, "NEWS_NO")%>&pageNum=<%=pageNum%>"><%=vnbListDao.getString(i, "TITLE")%></a></td>

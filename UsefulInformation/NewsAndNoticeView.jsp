...
vnbDao = vnbAction.getNews(newsType, newsNo);   // 내용 조회
	...
	<div id="wrapper">
		...
		<div id="contents">
			...
			<div class="location">
				...
				<em class="on">News & Notice</em>
			</div>
			<h3 class="title">News & Notice</h3>

			<div class="tableType1">
				<table summary="News & Notice">
			...
			<div class="buttonLR">
				<span class="button btnColor3 btnSize3"><a href="NewsAndNoticeList.jsp?pageNum=<%=pageNum%>">List</a></span>
			</div>
		</div>
		<!-- //Contents -->
		<!-- Footer -->

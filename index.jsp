	...
	<div id="wrapper">
		...
		<div id="categori">
			...
			<dl class="frist">
				...
				<dd class="frist"><a href="/products/CategoryList.jsp?unspsc=21000000">Sản xuất linh kiện (<em>34</em>)</a></dd>
				<dd><a href="/products/CategoryList.jsp?unspsc=21000000">Sản xuất máy móc (<em>58</em>)</a></dd>
				<dd><a href="/products/CategoryList.jsp?unspsc=21000000">Thiết bị thí nghiệm (<em>62</em>)</a></dd>
				<dd><a href="/products/CategoryList.jsp?unspsc=21000000">Thiết bị xây dựng (<em>38</em>)</a></dd>
				<dd><a href="/products/CategoryList.jsp?unspsc=21000000">Thiết bị CNTT, Viễn thông (<em>43</em>)</a></dd>
				<dd><a href="/products/CategoryList.jsp?unspsc=21000000">Hệ thống phân phối (<em>88</em>)</a></dd>
				<dd><a href="/products/CategoryList.jsp?unspsc=21000000">Thiết bị giáo dục và giải trí (<em>124</em>)</a></dd>
				<dd><a href="/products/CategoryList.jsp?unspsc=21000000">Thiết bị điện, chiếu sáng (<em>33</em>)</a></dd>
				<dd><a href="/products/CategoryList.jsp?unspsc=21000000">May mặc, hành lý, Thiết bị chăm sóc cá nhân (<em>56</em>)</a></dd>
				<dd class="last"><a href="/products/CategoryList.jsp?unspsc=21000000">Thực phẩm, đồ uống, thuốc lá (<em>120</em>)</a></dd>
			</dl>
			<dl>
				<dt>Tất cả danh mục</dt>
				<% for(int i=0,j=muDao.getRowCnt(); i<j && i<=25; i++) { %>
				<dd <%= i==0? "class=frist":(i==25? "class=last":"") %>><a href="/products/CategoryList.jsp?unspsc=<%= muDao.getString(i, "UNSPSC") %>"><%= muDao.getString(i, "VN_TITLE") %></a></dd><% } %>
			</dl>
			<ul>
		...
		<div id="contents">
			...
			<div class="rollBox">
				...
				<div class="rollBoxItem" style="width:730px;">
					...
					<div  class="rollBoxItemDetail" style="width:675px;height:324px;margin-left:28px;">
						<div class="viewBoxIndex">
							<ul class="tab1" style="width:685px;margin-left:1px;">
							<% for(int i=0; i<20; i++) { %>
							<%= i>0 && i%10==0 ? "</ul><ul class='tab2' style=\"width:685px;margin-left:1px;\">":"" %>
							<% if(i<vfpDao.getRowCnt()){ %>
							<li<%= i>0 && (i+1)%5==0 ? " class='last'":"" %>><a href="<%= vfpDao.getString(i, "URL") %>" target="_blank"><img src="/images/products/<%=vfpDao.getInt(i, "GESI_NO")%>/<%= vfpDao.getString(i, "IMAGE") %>" alt="Product" width="117" height="117"/><em style="height:30px;"><%= vfpDao.getString(i, "PROD_NM") %></em></a></li>
							<% } else { %>

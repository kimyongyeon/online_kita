			...
			<div class="contentsDetail">	
				...
				<div class="location">
					...
					<span>
						<em>Main</em>&#62;
						<em>게시판 관리</em>&#62;
						<em class="on">Business Community 새 글 등록</em>
					</span>
				</div>
				<!-- //Location-->
				...
				<h4 class="title">Business Community 새 글 등록</h4>
				<div class="tableType1 tableLeftType2">
					<table summary="등록 및 수정 게시판">
						...
						<tbody>
							<tr>
								<th>제목</th>
								<td colspan="5" class="left"><input type="text" size="80"  name="title" /></td>
							</tr>
							<tr>
								<th>작성자</th>
								<td>Admin(관리자)</td>
							...
							<tr>
								<th>내용</th>
								<td colspan="3">									
										<textarea name="content" style="width:97%;height:300px" ></textarea>
